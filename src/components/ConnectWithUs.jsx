...
export default function ConnectWithUs() {
  return (
    <section id="contact" className="py-24 px-6 flex flex-col items-center w-full bg-[#F8F3E9]">
      <div className="max-w-[1152px] flex flex-col items-start gap-7 w-full">
        ...
        <div className="flex flex-col items-center w-full text-center">
          ...
          <h2 className="text-[#40312A] font-androgyDemo text-5xl leading-[48px] text-center mb-10">
        ...
        <div className="flex items-center gap-5 w-full flex-wrap lg:flex-nowrap">
          ...
          <div className="flex flex-col items-start gap-4 shrink-0 w-full lg:w-[689px]">
            ...
            <div className="flex items-center gap-5 w-full flex-wrap md:flex-nowrap">
              ...
              <div className="flex p-5 items-start gap-4 rounded-[14px] bg-[#FEFEFE] w-full md:w-[356px] h-[184px] shadow-xs">
              ...
              <div className="flex flex-col items-start gap-4 w-full md:w-[313px]">
                {/* Phone Card */}
          ...
          <div className="flex items-center rounded-2xl border-[3px] border-[rgba(71,20,20,0.08)] bg-[#EEE] w-full lg:w-[443px] h-[344px] overflow-hidden shadow-sm">
            <iframe
