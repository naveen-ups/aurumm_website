        ...
        <div className="flex gap-10 lg:gap-16 items-start flex-wrap lg:flex-nowrap">
          ...
          <div className="relative shrink-0 w-full lg:w-[457px]">
            ...
            <img 
              ...
              alt="" 
              className="absolute left-[-16px] sm:left-[-32px] top-[20%] w-[45px] sm:w-[64px] h-[56px] sm:h-[80px] object-contain opacity-90 z-10 pointer-events-none"
            />
            ...
            <img 
              ...
              alt="" 
              className="absolute right-[-16px] sm:right-[-32px] bottom-[20%] w-[45px] sm:w-[64px] h-[68px] sm:h-[96px] object-contain opacity-80 z-10 pointer-events-none"
            />
          </div>
